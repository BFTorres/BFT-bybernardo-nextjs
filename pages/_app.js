...
function MyApp({Component, pageProps}) {
    ...
    return (<>
        <Head>
            <title>Bernardo Fonseca Torres | Digital Craftsman</title>
            {/* <meta name="description" content="Generated by create next app"/> */}
            <meta name="description" content="Bernardo Fonseca Torres is a Software Developer and Multidisciplinary Designer based in Hannover, Germany. Currently, he working as a Frontend Developer and UX/UI Designer at Lohoff." />
            <meta name="keywords" content="Bernardo, Bernardo Fonseca Torres, Fonseca, Torres, Hannover, React, UX/UI Design, HTML, CSS, JavaScript, JS, Frontend, UX, UI, Design, Product Design, Web Development, Germany, Brazil, Bernardo Hannover" />
            <meta name="author" content="Bernardo Fonseca Torres" />
