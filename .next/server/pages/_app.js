...
;// CONCATENATED MODULE: ./components/cookie-banner/CookieBanner.jsx




const CookieBanner = ()=>{
    const [accepted, setAccepted] = useState( false ? 0 : false);
    const acceptCookies = ()=>{
    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            !accepted && /*#__PURE__*/ _jsx("div", {
                className: "jsx-13aefd1c5ee05870" + " " + "cookie-overlay"
            }),
            /*#__PURE__*/ _jsxs("div", {
                className: "jsx-13aefd1c5ee05870" + " " + `cookie-banner${accepted ? " accepted" : ""}`,
                children: [
                    /*#__PURE__*/ _jsx("h5", {
                        className: "jsx-13aefd1c5ee05870",
                        children: "This website uses cookies to ensure you get the best experience. By continuing to use this site, you consent to the use of cookies."
                    }),
                    /*#__PURE__*/ _jsx("button", {
                        onClick: acceptCookies,
                        className: "jsx-13aefd1c5ee05870" + " " + "cookie-accept-btn border-rdu",
                        children: "ACCEPT"
                    })
                ]
            }),
            _jsx(_JSXStyle, {
                id: "13aefd1c5ee05870",
                children: ".cookie-overlay.jsx-13aefd1c5ee05870{position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,.6);z-index:9998}.cookie-banner.jsx-13aefd1c5ee05870{font-family:var(--body-font);position:fixed;bottom:0;left:0;width:100%;background-color:#000;color:#fff;padding:35px 30px;z-index:9999;-webkit-transition:opacity.3s ease;-moz-transition:opacity.3s ease;-o-transition:opacity.3s ease;transition:opacity.3s ease;text-rendering:optimizeLegibility}.cookie-banner.accepted.jsx-13aefd1c5ee05870{opacity:0;pointer-events:none}.cookie-banner.jsx-13aefd1c5ee05870 p.jsx-13aefd1c5ee05870{margin:0}.cookie-accept-btn.jsx-13aefd1c5ee05870{background-color:#fafafa;color:var(--assistant-color)!important;border:none;padding:20px 30px;margin-top:30px;font-family:var(--heading-font);font-size:var(--font-size-h6);line-height:16px;letter-spacing:3px;font-weight:500;text-transform:uppercase;cursor:pointer}.cookie-accept-btn.jsx-13aefd1c5ee05870:hover{background-color:var(--theme-color);color:var(--reverse-color)!important}"
            })
        ]
    });
};
/* harmony default export */ const cookie_banner_CookieBanner = ((/* unused pure expression or super */ null && (CookieBanner)));
...
/* harmony import */ var _hooks_spltting__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7011);
...
function OptionTheme({ className ="" , lineTheme , pageColor  }) {
    const styleColor = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
    const styleLayout = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
    const [creativeLine, setCreativeLine] = lineTheme;
    const [colorPage, setColorPage] = pageColor;
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        _hooks_spltting__WEBPACK_IMPORTED_MODULE_2__/* ["default"].Char */ .ZP.Char(styleColor.current);
        _hooks_spltting__WEBPACK_IMPORTED_MODULE_2__/* ["default"].Char */ .ZP.Char(styleLayout.current);
    }, []);
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: (0,_hooks_helper__WEBPACK_IMPORTED_MODULE_3__/* .dsnCN */ .gU)("box-options c-hidden d-flex align-items-center", className),
        children: [
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (OptionTheme);
...
// EXTERNAL MODULE: ./components/option-theme/OptionTheme.tsx
var OptionTheme = __webpack_require__(8099);
...
// EXTERNAL MODULE: ./components/cookie-banner/CookieBanner.jsx + 1 modules
var CookieBanner = __webpack_require__(5354);
;// CONCATENATED MODULE: external "vanilla-cookieconsent"
const external_vanilla_cookieconsent_namespaceObject = require("vanilla-cookieconsent");
// EXTERNAL MODULE: ./node_modules/vanilla-cookieconsent/dist/cookieconsent.css
var cookieconsent = __webpack_require__(7132);
;// CONCATENATED MODULE: ./components/cookie-consent/CookieConsentConfig.js
/**
 * @type {UserConfig}
 */ const pluginConfig = {
    current_lang: "en",
    ...
    languages: {
        en: {
            consent_modal: {
                ...
                description: 'See <button type="button" data-cc="c-settings" class="cc-link">Cookie Notice</button> for details',
                primary_btn: {
                    text: "Accept all",
                    role: "accept_all"
                },
...
/* harmony default export */ const CookieConsentConfig = (pluginConfig);

;// CONCATENATED MODULE: ./components/cookie-consent/CookieConsent.jsx
...
/* harmony default export */ const cookie_consent_CookieConsent = (CookieConsent);
...
function MyApp({ Component , pageProps  }) {
    ...
    //--> v-dark , v-light
    const [colorPage, setColorPage] = (0,external_react_.useState)("v-light");
    (0,external_react_.useEffect)(()=>{
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(external_react_redux_.Provider, {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx(cookie_consent_CookieConsent, {}),
                        /*#__PURE__*/ jsx_runtime_.jsx(Component, {
                            ...pageProps
                        }),
                        /*#__PURE__*/ jsx_runtime_.jsx(OptionTheme/* default */.Z, {
                            lineTheme: [
                                creativeLine,
                                setCreativeLine
                            ],
...
var __webpack_exports__ = __webpack_require__.X(0, [9210,9403,1664,3121,5675,4597,1688,7011], () => (__webpack_exec__(5027)));
